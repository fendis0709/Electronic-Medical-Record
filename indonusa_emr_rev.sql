...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COMMENT='Menampung data pemeriksaan pasien pada dokter';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COMMENT='Menampung data dokter';
...
INSERT INTO `lab` (`id`, `user_id`, `name`, `mobile`, `telephone`, `city`, `address`, `photo`, `created_at`, `updated_at`) VALUES
	(1, 4, 'Lab Kece', '9834984', '2732837', 'Surabaya', 'Jln. Kedurus No 4D', '/storage/assets/userfile/lab/d434febbe8123bcebbde624b9bca7221.jpeg', '2016-12-20 17:39:48', '2016-12-22 20:18:35'),
...
INSERT INTO `lab_checkup` (`id`, `checkup_id`, `lab_id`, `patient_id`, `result`, `date`, `notes`, `photo`, `created_at`, `updated_at`) VALUES
	...
	(4, 0, 1, 1, NULL, '2016-12-31', NULL, NULL, '2016-12-22 19:36:00', '2016-12-22 19:36:00'),
...
CREATE TABLE IF NOT EXISTS `patient` (
  ...
  UNIQUE KEY `nik` (`nik`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1 COMMENT='Menampung data pasien';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='Menampung data resep obat untuk pasien secara garis besar\r\n';

-- Dumping data for table indonusa_emr_rev.prescription: ~1 rows (approximately)
...
INSERT INTO `prescription` (`id`, `checkup_id`, `doctor_id`, `patient_id`, `date`, `note`, `amount`, `created_at`, `updated_at`) VALUES
	...
	(2, 6, NULL, 11, '2016-12-29', NULL, NULL, '2016-12-24 11:58:30', '2016-12-24 11:58:30');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='Menampung data detail resep obat';

-- Dumping data for table indonusa_emr_rev.prescription_detail: ~2 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=latin1 COMMENT='Menampung data akun pengguna aplikasi (Admin, Dokter, Lab, Farmasi, Pasien)';

-- Dumping data for table indonusa_emr_rev.users: ~9 rows (approximately)
...
INSERT INTO `users` (`id`, `email`, `password`, `name`, `city`, `address`, `mobile`, `telephone`, `status`, `remember_token`, `is_verified`, `is_enabled`, `created_at`, `updated_at`) VALUES
	(1, 'admin@emr.com', '$2y$10$fBA5d6Xm/hK1Trkb/EZfSO1jCofdFkwopWW7K7so5Wi1mYoFBay7q', 'Admin Master Gaul Bro', 'Sidoarjo', 'Jln. Kedurus No 4A', '085707824788', '0212121212', 'Admin', 'l1OrSnfq1IbqdW8Brpr2OqC4np5XmZv78Efw7K2D3poxgqzNh6Evzq3ie6Vv', 1, 1, '2016-12-17 16:37:49', '2016-12-24 12:03:50'),
	(2, 'dokter@emr.com', '$2y$10$ICnc/5XotrSovcT3jCYqWOLZdaLc2ger26d8bfr.dSrsyPawlQC4u', 'Dokter Kece', 'Surabaya', 'Jln. Kedurus No 4B', '08570897837483', '012123233', 'Doctor', 'ZBuPRSOYZJ1NRpp4zCh0l5lU15lFQMz3k0SXDyXBWzwKHXisxZf6aQgzKX7y', 1, 1, '2016-12-17 16:46:47', '2016-12-24 15:52:23'),
	(3, 'farmasi@emr.com', '$2y$10$Ick56wjDt7d2mQd/G/FkaelpMbd5EXYa1pKz13.hgTVNtrErmbvuW', 'Farmasi Kece Abis', 'Surabaya', 'Jln. Kedurus No 4C', '08570897837483', '012123233', 'Pharmacy', 'xjN57VOIP0IlkLM4IniiXLDAyEHB29YSx0JdZAWdqNCDKOown0IGSY66KSJP', 1, 1, '2016-12-17 16:47:42', '2016-12-24 16:18:09'),
	(4, 'lab@emr.com', '$2y$10$hNyRi17F0ah1zMYLyLi0euyJAhKiC4FHxLI.3XuUq6tyoq4EwrRp6', 'Lab Kece', 'Surabaya', 'Jln. Kedurus No 4D', '08570897837483', '012123233', 'Lab', 'qTz3lUVRlRc1S98KPlOqdS3V0HnhtorJ1GQDKXeRwPUU5PqjyaxPIUiNYIpu', 1, 1, '2016-12-19 13:40:00', '2016-12-23 21:12:02'),
	(5, 'pasien@emr.com', '$2y$10$hJkMNmE6VAYably/W1y.ceaF6AjdUhIed4Vciwr6iYej7gZGpTEpu', 'Pasien Kece', 'Surabaya', 'Jln. Kedurus No 4E', '08570897837483', '012123233', 'Patient', 'PddoHYk5WDMSZLgrdszS0IPj3ZqsFceaqYEeJuFBMuZeY5clY8EYivYxzZyK', 1, 1, '2016-12-19 13:41:20', '2016-12-23 08:26:47'),
	...
	(56, 'farm_2@emr.com', NULL, 'Farmasi kedus', 'Sidoarjo', 'Jl. Krian ', '08233849384', '031433498', 'Pharmacy', NULL, 0, 1, '2016-12-22 17:03:35', '2016-12-22 17:03:35'),
