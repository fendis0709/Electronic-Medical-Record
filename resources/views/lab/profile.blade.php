            ...
            <div class="col-md-4">
                ...
                <div class="box box-widget widget-user">
                    ...
                    <div class="widget-user-header bg-aqua-active">
                        ...
                        <h3 class="widget-user-username">{{ $r_lab->name }}</h3>
                        <h5 class="widget-user-desc">Laboratorium</h5>
                        @endforeach
                    </div>
                ...
                <div class="box box-primary hidden">
                    <div class="box-body box-profile">
                        ...
                        <p class="text-muted text-center">Lab</p>
