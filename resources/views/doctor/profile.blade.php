                                ...
                                foreach ($account as $r_account) {
                                    ...
                                    <div class="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                {{ $r_doctor->gender == 'L' ? 'Laki - laki' : 'Perempuan'}}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <?php echo date('d-M-Y', strtotime($r_doctor->birth_date)) ?>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row margin-bottom">
                                                    <div class="col-sm-6">
                                                        <img class="img-responsive" src="{{ asset($r_doctor->photo) }}" alt="Photo">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
