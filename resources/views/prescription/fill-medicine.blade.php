...
<title>EMR Dokter | Isi Resep Obat</title>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Resep Obat
            <small>Isi Resep Obat Pasien</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="">Resep Obat</li>
            <li class="active">Isi Resep Obat</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#profile" data-toggle="tab">Resep Obat Pasien</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="active tab-pane" id="profile">
                            <h4>Data resep obat pasien hari ini</h4>
                                            ...
                                            <div class="box-footer">
                                                <div class="row">
                                                    <div class="col-md-9 col-md-push-2">
                                                        ...
                                                        <div class="col-md-3">
                                                            <button type="submit" name="action" value="submit" class="btn btn-warning btn-block" onclick="return confirm('Apakah Anda yakin untuk me-submit data resep obat ini?')">Submit Resep Obat</button>
                                                        </div>
                                                        <div class="col-md-3">
