...
<title>EMR | Cari Resep Obat Lab</title>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Resep Farmasi
            <small>Cari Resep Farmasi</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#profile" data-toggle="tab">Cari Resep Farmasi</a></li>
                    </ul>
                            ...
                            <form class="form-horizontal" method="POST" action="{{ url('patient/prescription/search') }}">
                                ...
                                <form class="form-horizontal" method="POST" action="{{ url('pharmacy/prescription/search') }}">
                                    ...
                                    <div class="form-group">
                                        <label for="inputExperience" class="col-sm-2 control-label">Tanggal Resep Obat</label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <a href="search-result">
                                                <button type="submit" class="btn btn-warning">Cari Resep Obat</button>
                                            </a>
                                        </div>
                                    </div>
                                </form>
