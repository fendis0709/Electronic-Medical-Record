                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="password">
                            <form class="form-horizontal" action="{{ url('admin/profile/edit/password') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
//                                    echo var_dump(DB::table('users')->where('email', 'admin@emr.com')->where('password', password_verify('adsmin', PASSWORD_DEFAULT))->get());
                                    ?>
                                    <div class="col-sm-8">
