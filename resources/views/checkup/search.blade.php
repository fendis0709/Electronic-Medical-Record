...
<title>EMR | Cari Pemeriksaan</title>
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#profile" data-toggle="tab">Cari Pemeriksaan</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="active tab-pane" id="profile">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ url('doctor/checkup/search') }}">
                            @elseif(Auth::user()->status == 'Patient')
                            <form class="form-horizontal" method="POST" action="{{ url('patient/checkup/search') }}">
                            @endif
