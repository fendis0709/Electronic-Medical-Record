                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ url('lab/profile') }}" class="btn btn-default btn-flat">Profil</a>
                            </div>
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <p>{{ Auth::user()->name }}</p>
                <a href="#"><i class="fa fa-circle text-red"></i> Laboratorium</a>
            </div>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('lab/checkup/add') }}"><i class="fa fa-circle-o"></i> Tambahkan Pasien</a></li>
                    <li><a href="{{ url('lab/checkup/search') }}"><i class="fa fa-circle-o"></i> Cari Pemeriksaan</a></li>
                    <li><a href="{{ url('lab/checkup/history') }}"><i class="fa fa-circle-o"></i> Pemeriksaan Terdahulu</a></li>
                    <li><a href="{{ url('lab/checkup/future') }}"><i class="fa fa-circle-o"></i> Pemeriksaan Mendatang</a></li>
                </ul>
            </li>
