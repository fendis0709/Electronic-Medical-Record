                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ url('pharmacy/profile') }}" class="btn btn-default btn-flat">Profil</a>
                            </div>
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <p>{{ Auth::user()->name }}</p>
                <a href="#"><i class="fa fa-circle text-red"></i> Farmasi</a>
            </div>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('pharmacy/prescription/add') }}"><i class="fa fa-circle-o"></i> Tambahkan Resep Pasien</a></li>
                    <li><a href="{{ url('pharmacy/prescription/search') }}"><i class="fa fa-circle-o"></i> Cari Resep Obat</a></li>
                    <li><a href="{{ url('pharmacy/prescription/history') }}"><i class="fa fa-circle-o"></i> Resep Obat Terdahulu</a></li>
                    <li><a href="{{ url('pharmacy/prescription/future') }}"><i class="fa fa-circle-o"></i> Resep Obat Mendatang</a></li>
                </ul>
            </li>
